...
export default async function main() {
    ...
    if (logResult('Part 1 test', await part1(loadLines('11_Cosmic_Expansion/sampleData1.txt')), 0))
        logResult('Part 1', await part1(loadLines('11_Cosmic_Expansion/input.txt')))

    // log();

    // if (logResult('Part 2 test', await part2(loadLines('11_Cosmic_Expansion/sampleData2.txt')), 0))
